...
class Tests(unittest.TestCase):
    ...
    def test_sign(self):
        ...
        Ri3_hashed = p3.sample_random_rij()
        all_commitments = (Ri1_hashed, Ri2_hashed, Ri3_hashed)
        ...
        p3.validate_other_party_nonce_commitments()

        # Round 3.1
        p1.compute_aggregate_nonce_R_i()
        p2.compute_aggregate_nonce_R_i()
        R_i = p3.compute_aggregate_nonce_R_i()

        # # Obtain other parties aggregate nonce commitments
        # p1.final_aggregate_R = R_i # THIS SHOULD BE FINAL VALUE FROM MUSIG
        # p2.final_aggregate_R = None
        # p3.final_aggregate_R = None
